...
(function (module) {
    var standardChartPanelFn = function () { // standard-chart-panel directive
        return {
            restrict: 'E',
            scope: {
                chartId: '@',
            ...
            templateUrl: 'app/partials/standard-chart-panel.html',
            link: function (scope) {
                scope.cursorPoint = {x: 0, y: 0}
            }
        };

    }, standardChartCtrlFn = function ($scope, d3, $window, $interval) { // standard-chart controller
        var svgPoint = null;
    ...
    }, standardChartFn = function ($window) { // standard-chart directive
        return {
            restrict: 'E',
            scope: {
                chartId: '@',
            ...
            controller: standardChartCtrlFn,
    ...
    standardChartCtrlFn.$inject = ['$scope', 'd3', '$window', '$interval'];
    standardChartFn.$inject = ['$window'];

    module
        .directive('standardChartPanel', standardChartPanelFn)
        .directive('standardChart', standardChartFn)
}
(angular.module('standardMetrics')));
